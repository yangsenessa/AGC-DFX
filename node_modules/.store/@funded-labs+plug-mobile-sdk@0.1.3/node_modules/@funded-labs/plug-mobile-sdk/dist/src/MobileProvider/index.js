...
const walletConnect_1 = require("../constants/walletConnect");
...
const ICP_WC_NAMESPACE = {
    icp: {
        methods: walletConnect_1.WC_METHODS,
        events: ['chainChanged", "accountsChanged'],
        chains: [walletConnect_1.WC_CHAIN_ID],
    },
};
class MobileProvider {
    constructor(options) {
        ...
        if (backedUpSession) {
            this.localIdentity = identity_secp256k1_1.Secp256k1KeyIdentity.fromJSON(backedUpSession);
        }
        else {
            this.localIdentity = identity_secp256k1_1.Secp256k1KeyIdentity.generate();
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            const provider = yield universal_provider_1.default.init({
    ...
    createAgent({ host, targets }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new agent_1.HttpAgent({ identity: this.delegatedIdentity, host });
        });
    }
    isPaired() {
    ...
    callViaWalletConnect(method, params) {
        ...
        return (_a = this.provider) === null || _a === void 0 ? void 0 : _a.client.request({
            chainId: walletConnect_1.WC_CHAIN_ID,
    ...
    createIdentityFromDelegation(delegation) {
        const delegationChain = identity_1.DelegationChain.fromJSON(delegation);
        localStorage.setItem(DELEGATION, delegation);
        return identity_1.DelegationIdentity.fromDelegation(this.localIdentity, delegationChain);
    }
    createDelegatedIdentity(targets) {
        return __awaiter(this, void 0, void 0, function* () {
            const publicKey = arrayBuffer_1.arrayBufferToBase64(this.localIdentity.getPublicKey().derKey);
...
exports.default = MobileProvider;
