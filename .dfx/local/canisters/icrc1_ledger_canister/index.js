...
export const canisterId = process.env.CANISTER_ID_ICRC1_LEDGER_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icrc1_ledger_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icrc1_ledger_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icrc1_ledger_canister.did.js")._SERVICE>}
 */
