...
import { idlFactory } from './voice_ledger_canister.did.js';
export { idlFactory } from './voice_ledger_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_VOICE_LEDGER_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./voice_ledger_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the voice_ledger_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./voice_ledger_canister.did.js")._SERVICE>}
 */
export const voice_ledger_canister = createActor(canisterId);
