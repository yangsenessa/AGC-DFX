...
import { idlFactory } from './univoice-vmc-backend.did.js';
export { idlFactory } from './univoice-vmc-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_UNIVOICE_VMC_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./univoice-vmc-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the univoice-vmc-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./univoice-vmc-backend.did.js")._SERVICE>}
 */
export const univoice_vmc_backend = createActor(canisterId);
