...
export const canisterId = process.env.CANISTER_ID_ICRC1_INDEX_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icrc1_index_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icrc1_index_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icrc1_index_canister.did.js")._SERVICE>}
 */
export const icrc1_index_canister = createActor(canisterId);
