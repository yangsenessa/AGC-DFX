...
export const canisterId = process.env.CANISTER_ID_UNIVOICE_VMC_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./univoice-vmc-frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the univoice-vmc-frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./univoice-vmc-frontend.did.js")._SERVICE>}
 */
export const univoice_vmc_frontend = createActor(canisterId);
