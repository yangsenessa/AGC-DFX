...
export const canisterId = process.env.CANISTER_ID_MUGC_AGC_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./mugc-agc-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the mugc-agc-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./mugc-agc-backend.did.js")._SERVICE>}
 */
export const mugc_agc_backend = createActor(canisterId);
