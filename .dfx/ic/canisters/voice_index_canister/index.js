...
import { idlFactory } from './voice_index_canister.did.js';
export { idlFactory } from './voice_index_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_VOICE_INDEX_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./voice_index_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the voice_index_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./voice_index_canister.did.js")._SERVICE>}
 */
export const voice_index_canister = createActor(canisterId);
